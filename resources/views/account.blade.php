...
@section('content')
    ...
    <div class="ant-row ant-row-center">
        <div class="ant-col ant-col-xs-24 ant-col-md-16 ant-col-xl-12">
            ...
            <div style="margin: 32px 0px 12px;">ฝ่ายบริการลูกค้า</div>
            <div class="ant-row" style="margin-left: -8px; margin-right: -8px; row-gap: 16px;">
                <div class="ant-col ant-col-24" style="padding-left: 8px; padding-right: 8px;">
                    <a href="{{ Session::get('Line') }}" target="_blank" rel="noreferrer" class="account-menu">
