    ...
    <div class="ant-row ant-row-center">
        <div class="ant-col ant-col-xs-24 ant-col-md-16">
            <div class="ant-radio-group ant-radio-group-solid transaction-tab" style="margin-bottom: 16px;">
                <label class="ant-radio-button-wrapper {{ Request::segment(2) === 'deposit' ? 'ant-radio-button-wrapper-checked' : null }}">
                ...
                <label class="ant-radio-button-wrapper {{ Request::segment(2) === 'withdraw' ? 'ant-radio-button-wrapper-checked' : null }}" onclick="window.location.href='{{ route('transactions-withdraw') }}?prefix={{ Session::get('Prefix') }}'">
                    <span class="ant-radio-button">
            ...
            <!-- <div class="tab-transaction-content">
                <div class="ant-empty ant-empty-normal">
                    ...
                    <div class="ant-empty-description">คุณไม่มีรายการอื่น ๆ</div>
                </div>
            </div> -->
        </div>
    </div>
