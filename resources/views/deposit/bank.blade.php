        ...
        <div class="ant-col ant-col-xs-12 ant-col-sm-6 ant-col-lg-8 ant-col-xl-6 ant-col-xxl-4" style="padding-left: 8px; padding-right: 8px;">
            <div class="bank-deposit-card">
                <div class="bank-card-logo">
                    <img width="80" src="{{ asset('media/'.$data['Bank']) }}.png" alt="{{ $data['Bank_Th'] }}" style="border-radius: 16px;">
                </div>
                <div class="bank-card-info">
                    <div>
                        <small>{{ $data["Bank_Th"] }}</small>
                    </div>
                    <div class="bank-deposite-account">{{ $data["Bank_Account"] }}</div>
                    <div>
                        <small>{{ $data["Bank_Name"] }}</small>
                    </div>
                    <button type="button" class="ant-btn ant-btn-link" onclick="copyDepositBank('{{ $data['Bank_Account'] }}')">
